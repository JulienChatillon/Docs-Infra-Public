...
2.  **Site-to-Site :** Hebergement d'une connexion sécurisée entre mon laboratoire et plusieurs infras distantes partenaires (SIO) via un transit dédié (10.250.0.0/24).
